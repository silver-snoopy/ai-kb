...
export const NARRATOR_LINES: readonly NarratorLine[] = [
  ...
  { trigger: 'spell-cast', text: "The warlock's focus sharpens. Something old rises to her aid." },
  { trigger: 'spell-cast', text: 'An answer she did not know she knew arrives unbidden.' },
  { trigger: 'spell-cast', text: 'The spellbook remembers for her. She lets it.' },
  { trigger: 'spell-cast', text: 'A quiet word. A certainty that was not there before.' },
  ...
  { trigger: 'hero-defeated', text: 'She came to answer, and found a question she could not.' },
